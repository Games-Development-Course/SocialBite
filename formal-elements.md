...
**תהליך הליבה:**  
בכל שלב, כל שחקן מקבל חלק אחר של חידה (רמז, צבע, צליל, או נתון מספרי), ורק באמצעות תקשורת ושיתוף פעולה ניתן לפתור אותה ולהשיג את המרכיב הבא למנה.
דוגמאות לחידות:

🧮 חידת כספת מספרית: שחקן אחד רואה את המספרים הנכונים, והשני את הסדר — רק אם ישתפו מידע יצליחו לפתוח את הכספת.

🎵 חידת צבעים וצלילים: שחקן אחד שומע רצף צלילים והשני רואה רצף צבעים — הם צריכים להתאים ביניהם את הצליל לצבע וליצור תבנית נכונה.

🔍 חידת המעבדה: שחקן אחד רואה שמות חפצים והשני את הציורים שלהם — עליהם לזהות שלושה פריטים שקשורים זה לזה כדי ליצור "ניסוי מוצלח".

פתרון נכון מעניק לשחקנים מרכיב חדש (כמו חסה, קציצה או לחמנייה) המתווסף למסך ההתקדמות.
לאחר פתרון כל החידות, המנה מורכבת באנימציה צבעונית וחגיגית שמדגישה את שיתוף הפעולה וההצלחה המשותפת..
...
הדגש על **פיתוח מיומנויות חברתיות וקידום קוגניטיבי ורגשי** דרך משחק משותף עם חידות הדורשות שיתוף מידע, ולא רק פעולה טכנית.  
.
